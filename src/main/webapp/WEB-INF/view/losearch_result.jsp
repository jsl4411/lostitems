					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<c:if test="${ empty loginuser && empty klogin}">
			           			<a href="../gxsx/login.do"><img src="../images/Lostimgs/${lostitem.lopicname}" alt="IMG-PRODUCT"></a>
			           		</c:if>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<span class="m-r-3">
									<c:if test="${ empty loginuser && empty klogin}">
					           			<a href="../gxsx/login.do"><span class="cl5">${lostitem.losub}</span></a>
					           		</c:if>
					           		<c:if test="${ (!empty loginuser && empty kakaologout_url) || (!empty klogin && !empty kakaologout_url)}">
										<a href="../lostitem/locontent.do?lono=${lostitem.lono}"><span class="cl5">${lostitem.losub}</span></a>
									</c:if>
								</span>
